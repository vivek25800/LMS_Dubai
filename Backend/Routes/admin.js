...
const {post_oja_data, get_oja_details, get_oja_details_byIds, updateOjaInfo, delete_oja_data} = require('../Controllers/create_Oja_form');
const {post_ina_data, get_ina_data, get_ina_data_byIds, updateInaInfo, delete_Ina_data}  = require('../Controllers/create_INA_form');
