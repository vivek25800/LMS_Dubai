    ...
    const filteredAssessments = assessment?.filter(assessment => 
      ...
      const handleAssignAssessment = async () => {
        if (!selectedAssessment) {
          toast.error('Please select a Assessment first');
          return;
        }
        ...
        try {
          const response = await axios.post(`${base_url}/assign_assessment`, {
          ...
          toast.error(error.response?.data?.message || 'Error assigning Assessment');
        }
      };
            ...
            <section className="main-content-section">
                ...
                <div className='take-assessment-container'>
                    <div className="title-text">
                        <h2>Assign <span style={{ fontWeight: "300" }}>Assessment</span></h2>
                    </div>
                        ...
                        <div className='assessment-data'>
                            ...
                            <div className="button-container" style={{ marginTop: '1rem' }}>
                              <button
                                ...
                                disabled={!selectedAssessment || selectedEmployees.length === 0}
                              >
                                Assign Assessment to Selected Employees
                              </button>
                            </div>
                        </div>
                    </div>
