            ...
            <section className="main-content-section">
                ...
                <div className='take-assessment-container'>
                    <div className="title-text">
                        <h2>Take <span style={{ fontWeight: "300" }}>Survey</span></h2>
                    </div>
                            ...
                            quizData.map((item, index) => (
                                <div className='assessment-items' key={item._id}>
                                    ...
                                    <div className='assessment-actions' style={{display:"flex", justifyContent:"space-between", width:"240px"}}>
                                        ...
                                        <p style={{marginBottom:"0px", cursor:"pointer", color:"#036bfc"}} onClick={() => navigate(`/takeQuiz/${item._id}`)} > <i class="fa-regular fa-pen-to-square"></i> Take survey</p>
                                    </div>
                                </div>
                            ))
                        ) : (
